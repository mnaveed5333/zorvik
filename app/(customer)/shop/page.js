...
export default function ShopPage() {
  ...
  // Keep state in sync if the URL's ?category= changes (e.g. navigating again from home)
  useEffect(() => {
    const urlCategory = searchParams.get("category") || "all";
    setCategory(urlCategory);
  }, [searchParams]);

  // Update URL when user picks a category from the dropdown, without full reload
